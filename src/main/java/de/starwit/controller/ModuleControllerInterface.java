...
public interface ModuleControllerInterface {
     ...
     */
    @Operation(operationId = "getModule", description = "delivers components/modules with provided id", responses = {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/modules/{id}", produces = { "application/json" })
     ...
     */
    @Operation(operationId = "getModules", description = "delivers a list of components/modules of which AI system is composed", responses = {
     ...
     */
    @Operation(operationId = "registerModule", description = "register a new module", responses = {
            @ApiResponse(responseCode = "200", description = "created a new module")
    })
    @RequestMapping(method = RequestMethod.POST, value = "/modules/register", consumes = { "application/json" })

    default ResponseEntity<ValidationDto> registerModule(
     ...
     */
    @Operation(operationId = "updateModule", description = "update a module", responses = {
            @ApiResponse(responseCode = "200", description = "updated a module")
    })
    @RequestMapping(method = RequestMethod.PUT, value = "/modules/register/{id}", consumes = { "application/json" })
